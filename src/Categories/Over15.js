...
class Over15 extends Component {
  constructor(props) {
    super(props);
...
Over15.defaultProps = {  
  ...
  aenddate: moment().add(1, 'hours').format("DD-MM-YYYY hh:mm:ss"),
  bstartdate:  moment().format("DD-MM-YYYY hh:mm:ss"),
  benddate: moment().add(3, 'hours').format("DD-MM-YYYY hh:mm:ss"),
  diff: moment().add(1, 'hours').diff(moment(),'seconds'),
  diffb: moment().add(3, 'hours').diff(moment(),'seconds')
};

export default Over15;